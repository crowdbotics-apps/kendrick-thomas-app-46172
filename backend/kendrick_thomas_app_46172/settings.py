"""
Django settings for kendrick_thomas_app_46172 project.
...
ROOT_URLCONF = 'kendrick_thomas_app_46172.urls'
...
WSGI_APPLICATION = 'kendrick_thomas_app_46172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kendrick_thomas_app_46172 API",
    "DESCRIPTION": "API documentation for kendrick_thomas_app_46172 App",
    "VERSION": "v1",
}
